...
Default branch (2026-09-23): `claude/portrait-segmentation-overlay-4kh36c`, not `claude/repo-review-security-baiyud`, the branch this work was done on, so neither Dependabot's security updates nor CI's weekly run reach this work until `main` is created from it and made the default (shared items 4 and 10).
